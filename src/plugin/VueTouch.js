/* @copy https://segmentfault.com/a/1190000013922322 */
class VueTouchImpl {
  /**
   * @param el 绑定的DOM
    ...
    install: function(Vue, options) {
        Vue.directive("tap", {
            bind: function (el, binding) {
              new VueTouchImpl(el, binding, "tap");
            }
          });
          Vue.directive("swipe", {
            bind: function (el, binding) {
              new VueTouchImpl(el, binding, "swipe");
            }
          });
          Vue.directive("swipeleft", {
            bind: function (el, binding) {
              new VueTouchImpl(el, binding, "swipeleft");
            }
          });
          Vue.directive("swiperight", {
            bind: function (el, binding) {
              new VueTouchImpl(el, binding, "swiperight");
            }
          });
          Vue.directive("swipedown", {
            bind: function (el, binding) {
              new VueTouchImpl(el, binding, "swipedown");
            }
          });
          Vue.directive("swipeup", {
            bind: function (el, binding) {
              new VueTouchImpl(el, binding, "swipeup");
            }
          });
          Vue.directive("longtap", {
            bind: function (el, binding) {
              new VueTouchImpl(el, binding, "longtap");
            }
          });
    }
};
